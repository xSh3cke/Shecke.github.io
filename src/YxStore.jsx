...
const TRANSLATIONS = {
  es: {
    ...
    product: { includes: 'Qué incluye', requirements: 'Requisitos', changelog: 'Historial de versiones', version: 'Versión', close: 'Cerrar' },
  ...
  en: {
    ...
    product: { includes: "What's included", requirements: 'Requirements', changelog: 'Version history', version: 'Version', close: 'Close' },
  ...
  fr: {
    ...
    product: { includes: 'Contenu inclus', requirements: 'Prérequis', changelog: 'Historique des versions', version: 'Version', close: 'Fermer' },
  ...
  de: {
    ...
    product: { includes: 'Was ist enthalten', requirements: 'Voraussetzungen', changelog: 'Versionsverlauf', version: 'Version', close: 'Schließen' },
  ...
  pt: {
    ...
    product: { includes: 'O que está incluído', requirements: 'Requisitos', changelog: 'Histórico de versões', version: 'Versão', close: 'Fechar' },
  ...
  it: {
    ...
    product: { includes: 'Cosa include', requirements: 'Requisiti', changelog: 'Cronologia versioni', version: 'Versione', close: 'Chiudi' },
  ...
  ja: {
    ...
    product: { includes: '含まれるもの', requirements: '必要条件', changelog: 'バージョン履歴', version: 'バージョン', close: '閉じる' },
  ...
  zh: {
    ...
    product: { includes: '包含内容', requirements: '系统要求', changelog: '版本历史', version: '版本', close: '关闭' },
  ...
  ko: {
    ...
    product: { includes: '포함 내용', requirements: '요구 사항', changelog: '버전 기록', version: '버전', close: '닫기' },
  ...
  ru: {
    ...
    product: { includes: 'Что входит', requirements: 'Требования', changelog: 'История версий', version: 'Версия', close: 'Закрыть' },
...
const PRODUCTS = [
  { id: 1, name: 'Admin System Pro', tag: 'ADMIN', price: 49.99, rating: 4.9, installs: '18.4k', version: '3.4.1', featured: true, description: 'Panel de administración completo con más de 80 comandos, jerarquía de rangos y registro de acciones.', specs: ['80+ comandos', 'Logs en tiempo real', 'Rangos personalizables'], includes: ['Código fuente completo (.rbxm + .lua)', 'Panel de administración con UI incluida', 'Sistema de rangos con herencia', 'Registro de acciones exportable a Discord', 'Documentación paso a paso'], requirements: ['Roblox Studio actualizado', 'DataStore habilitado en el juego', 'API Services activados'], changelog: [{ v: '3.4.1', note: 'Corrección de comando /freeze en servidores con +40 jugadores' }, { v: '3.4.0', note: 'Nuevo sistema de logs con filtro por jugador' }, { v: '3.3.0', note: 'Soporte para rangos personalizados por grupo' }] },
  { id: 2, name: 'Economy Core', tag: 'ECONOMÍA', price: 59.99, rating: 4.9, installs: '22.1k', version: '2.8.0', featured: true, description: 'Motor de economía con tienda, trabajos, monedas múltiples e integración con DataStore.', specs: ['Multi-moneda', 'Tienda integrada', 'Anti-duplicación'], includes: ['Motor de economía modular', 'Tienda con interfaz lista para usar', 'Sistema de trabajos configurable', 'Protección anti-duplicación server-side', 'Panel de balance para administradores'], requirements: ['Roblox Studio actualizado', 'DataStore habilitado en el juego', 'MessagingService para sincronía multi-servidor'], changelog: [{ v: '2.8.0', note: 'Añadido soporte para hasta 5 monedas simultáneas' }, { v: '2.7.2', note: 'Mejora de rendimiento en guardado masivo' }, { v: '2.7.0', note: 'Nueva API pública para integrarse con otros sistemas' }] },
  { id: 3, name: 'Anti-Exploit Shield', tag: 'SEGURIDAD', price: 64.99, rating: 4.9, installs: '31.6k', version: '4.1.2', featured: true, description: 'Detección de exploits del lado del servidor con baneo automático y reportes en Discord.', specs: ['Detección server-side', 'Webhook a Discord', 'Cero falsos positivos'], includes: ['Motor de detección 100% server-side', 'Sistema de baneo automático configurable', 'Webhook a Discord con capturas de contexto', 'Panel de revisión de casos dudosos', 'Actualizaciones de firmas incluidas 12 meses'], requirements: ['Roblox Studio actualizado', 'HttpService activado para el webhook', 'Rango de administrador para el panel'], changelog: [{ v: '4.1.2', note: 'Nueva firma para exploits de teleport masivo' }, { v: '4.1.0', note: 'Reducción de falsos positivos en un 60%' }, { v: '4.0.0', note: 'Reescritura completa del motor de detección' }] },
  { id: 4, name: 'Chat Filter Ultra', tag: 'CHAT', price: 34.99, rating: 4.7, installs: '14.2k', version: '1.9.3', featured: false, description: 'Sistema de chat con filtrado avanzado, comandos de texto y burbujas personalizadas.', specs: ['Filtro configurable', 'Comandos por chat', 'Bubble chat propio'], includes: ['Sistema de chat con filtro configurable', 'Comandos activables por texto', 'Bubble chat con estilos personalizados', 'Lista de palabras editable', 'Documentación de integración'], requirements: ['Roblox Studio actualizado', 'TextService para el filtrado adicional'], changelog: [{ v: '1.9.3', note: 'Corrección de burbujas superpuestas en móvil' }, { v: '1.9.0', note: 'Nuevos estilos de burbuja incluidos' }] },
  { id: 5, name: 'Permission Manager', tag: 'SEGURIDAD', price: 39.99, rating: 4.8, installs: '9.8k', version: '2.2.0', featured: false, description: 'Gestión granular de permisos y roles con herencia jerárquica entre grupos.', specs: ['Roles anidados', 'Permisos por comando', 'Panel visual'], includes: ['Sistema de roles con herencia jerárquica', 'Permisos configurables por comando', 'Panel visual de asignación', 'Integración con grupos de Roblox', 'Documentación de la API interna'], requirements: ['Roblox Studio actualizado', 'Grupo de Roblox vinculado (opcional)'], changelog: [{ v: '2.2.0', note: 'Panel visual rediseñado' }, { v: '2.1.0', note: 'Soporte para permisos temporales' }] },
  { id: 6, name: 'Quest Engine', tag: 'GAMEPLAY', price: 54.99, rating: 4.6, installs: '7.5k', version: '1.6.1', featured: false, description: 'Motor de misiones con objetivos encadenados, recompensas dinámicas y seguimiento visual.', specs: ['Misiones encadenadas', 'Recompensas dinámicas', 'UI de seguimiento'], includes: ['Motor de misiones con objetivos encadenados', 'Sistema de recompensas dinámicas', 'UI de seguimiento en pantalla', 'Editor de misiones en Studio', 'Ejemplos de misiones preconfiguradas'], requirements: ['Roblox Studio actualizado', 'DataStore habilitado para progreso'], changelog: [{ v: '1.6.1', note: 'Corrección de progreso duplicado al reconectar' }, { v: '1.6.0', note: 'Editor visual de misiones añadido' }] },
  { id: 7, name: 'Inventory Framework', tag: 'INVENTARIO', price: 49.99, rating: 4.8, installs: '12.9k', version: '3.0.2', featured: false, description: 'Sistema de inventario modular con drag & drop, stacking y guardado persistente.', specs: ['Drag & drop', 'Stacking automático', 'Guardado persistente'], includes: ['Inventario modular con drag & drop', 'Stacking automático configurable', 'Guardado persistente vía DataStore', 'Interfaz lista para personalizar', 'Sistema de categorías de ítems'], requirements: ['Roblox Studio actualizado', 'DataStore habilitado en el juego'], changelog: [{ v: '3.0.2', note: 'Mejora de rendimiento con +200 ítems' }, { v: '3.0.0', note: 'Nueva UI con soporte para categorías' }] },
  { id: 8, name: 'Leaderboard Live', tag: 'ESTADÍSTICAS', price: 29.99, rating: 4.5, installs: '6.3k', version: '1.4.0', featured: false, description: 'Tablas de clasificación en tiempo real con múltiples categorías y actualización automática.', specs: ['Tiempo real', 'Multi-categoría', 'Ligero en rendimiento'], includes: ['Tablas de clasificación en tiempo real', 'Soporte para múltiples categorías', 'Actualización automática sin recarga', 'Diseño ligero pensado para bajo consumo', 'Panel de configuración simple'], requirements: ['Roblox Studio actualizado', 'DataStore habilitado en el juego'], changelog: [{ v: '1.4.0', note: 'Añadido soporte multi-categoría' }, { v: '1.3.0', note: 'Reducción de uso de memoria en un 30%' }] },
  { id: 9, name: 'Moderation Suite', tag: 'SEGURIDAD', price: 44.99, rating: 4.8, installs: '11.1k', version: '2.5.0', featured: false, description: 'Kit de moderación con kick, ban temporal, mute y historial completo de sanciones.', specs: ['Ban temporal', 'Historial completo', 'Panel de moderadores'], includes: ['Kit de moderación completo (kick/ban/mute)', 'Sistema de ban temporal con expiración', 'Historial de sanciones por jugador', 'Panel dedicado para moderadores', 'Registro exportable a Discord'], requirements: ['Roblox Studio actualizado', 'DataStore habilitado para el historial'], changelog: [{ v: '2.5.0', note: 'Nuevo panel de moderadores' }, { v: '2.4.0', note: 'Ban temporal con expiración automática' }] }
];
...
/* ---------- Reveal-on-scroll wrapper (no external animation lib) ---------- */
...
/* ---------- Cursor-glow wrapper for primary CTAs ---------- */
const GlowButton = ({ as: Tag = 'button', className = '', children, ...props }) => {
  const ref = useRef(null);
  const handleMove = (e) => {
    const node = ref.current;
    if (!node) return;
  ...
  return (
    <Tag ref={ref} className={`glowbtn ${className}`} onMouseMove={handleMove} {...props}>
...
export default function YxStore() {
  ...
  return (
    <div className="app">
          ...
          <div className="hero__grid">
            <div className="hero__copy">
              ...
              <div className="hero__actions">
                <GlowButton as="a" href="#shop" className="btn btn--primary btn--lg">
              ...
              <article className="card card--featured" key={p.id} style={{ '--delay': `${i * 90}ms` }}>
                <div className="card__top">
                  ...
                  <div className="card__topactions">
                    ...
                    <button className="infobtn" onClick={() => setInfoProduct(p)} aria-label={`${t.shop.viewDetails}: ${p.name}`}>
      ...
      {/* ================= PRODUCT INFO MODAL ================= */}
      <div className={`overlay ${infoProduct ? 'is-open' : ''}`} onClick={() => setInfoProduct(null)} />
      <div className={`modal modal--product ${infoProduct ? 'is-open' : ''}`} role="dialog" aria-modal="true" aria-hidden={!infoProduct}>
        {infoProduct && (
          <>
            <button className="modal__close" onClick={() => setInfoProduct(null)} aria-label={t.product.close}><Icon name="close" size={20} /></button>

            <div className="pinfo__head">
              <span className="tag">{infoProduct.tag}</span>
              <span className="pinfo__version"><Icon name="terminal2" size={13} />{t.product.version} {infoProduct.version}</span>
            </div>
            <h3 className="pinfo__title">{infoProduct.name}</h3>
            <div className="pinfo__meta">
              <span className="rating"><Icon name="star" size={14} className="rating__icon" />{infoProduct.rating}</span>
              <span className="pinfo__dot" />
              <span>{infoProduct.installs} instalaciones</span>
            </div>
            <p className="pinfo__desc">{infoProduct.description}</p>

            <div className="pinfo__section">
              <h4 className="checkout__label">{t.product.includes}</h4>
              <ul className="pinfo__list">
                {infoProduct.includes.map(item => <li key={item}><Icon name="check" size={14} />{item}</li>)}
              </ul>
            </div>
            ...
            <div className="pinfo__section">
              ...
              <ul className="pinfo__list pinfo__list--req">
                {infoProduct.requirements.map(item => <li key={item}><Icon name="info" size={14} />{item}</li>)}
              </ul>
            </div>
            ...
            <div className="pinfo__section pinfo__section--last">
              ...
              <ul className="pinfo__changelog">
                {infoProduct.changelog.map(entry => (
                  <li key={entry.v}>
            ...
            <div className="pinfo__footer">
              <div className="card__price">
                <span className="card__amount">{rate.symbol}{price(infoProduct.price)}</span>
                <span className="card__installs">{infoProduct.installs} instalaciones</span>
              </div>
              <GlowButton
